...
Testing Verified Commit using SSH last time
...
6.	Set directory permissions so that: a. webapp_user has full read, write, and execute access to everything.
- `sudo chmod -R u+rwx .`    

##### Members of the webapp_support group can:
